...
roundtrip, troubleshooting matrix 20 entri terverifikasi, 5 tiket + XLSX,
SLA mini, FAQ.
...
| Troubleshooting | 20 entri terverifikasi (JWT, EF, Blazor, Docker, Telegram, Playwright). |
| Tickets | 5 tiket (severity → pencegahan). Output: `KosManager-Tickets.xlsx`. |
